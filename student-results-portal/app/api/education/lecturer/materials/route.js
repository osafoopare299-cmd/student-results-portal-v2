...
export async function POST(request){
 ...
 try{
  ...
  const requestedAiApproval=Boolean(b.aiApproved),aiApproved=requestedAiApproval&&Boolean(contentText),aiApprovalDeferred=requestedAiApproval&&!aiApproved;
  ...
  return NextResponse.json({ok:true,material:rows[0],aiApprovalDeferred});
