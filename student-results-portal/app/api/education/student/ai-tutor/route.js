...
export async function POST(request) {
  ...
  try {
    ...
    if(!ranked.length){
      return NextResponse.json({ok:true,supported:false,mode,answer:'I could not find enough support for that topic in your lecturer-approved course materials. Choose a topic covered by your approved enrolled-course resources.',citations:[],questions:[]});
    }
